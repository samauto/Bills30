...
<div class="npi-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Npi'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            // 'Authorized_Official_Title_Position',
            // 'Authorized_Official_Telephone_Number',
            [
                'attribute'=>'Healthcare_Provider_Taxonomy_Code_1',
                'value'=>'taxonomy.tax_class',
            ],
